...
start_path = fullfile('/mnt/data1/sk135/Amplitude Mask/dataset/caps_1cap');
...
fid_w1 = fopen('train_meas_ilsvrc_flatcam.txt', 'w');
fid_w2 = fopen('val_meas_ilsvrc_flatcam.txt', 'w');
fprintf(fid_w1, '%s\n', files1{:});
fprintf(fid_w2, '%s\n', files2{:});
fclose(fid_w1);
fclose(fid_w2);