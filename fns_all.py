...
def train_full_epoch(gen, dis, vgg, wts, optim_gen, optim_dis, train_loader, val_loader, gen_criterion, dis_criterion, device, vla, e, savedir, train_error, val_error, disc_err,ss):
	i = 0
...
def train_full_epoch_tiknet(gen, dis, vgg, wts, optim_gen, optim_dis, train_loader, val_loader, gen_criterion, dis_criterion, device, vla, e, savedir, train_error, val_error, disc_err,ss):
	i = 0
	for X_train, Y_train in train_loader:
		X_train, Y_train = X_train.to(device), Y_train.to(device)
		# print(X_train.shape)
